...
class Lista {
  ...
  String get windSpeed => this.wind.speed.toStringAsFixed(1);
  String get humidity => this.main.humidity.toStringAsFixed(0);
  String get tempMaximum => this.main.tempMax.toStringAsFixed(0);
  String get tempMinimum => this.main.tempMin.toStringAsFixed(0);
